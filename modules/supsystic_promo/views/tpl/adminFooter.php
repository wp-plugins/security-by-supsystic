<div class="swrAdminFooterShell">
	<div class="swrAdminFooterCell">
		...
		<a target="_blank" href="http://worswress.org/plugins/supsystic-secure/changelog/"><?php echo SWR_VERSION?></a>
	</div>
	...
	<?php }?>
	<div class="swrAdminFooterCell">
		<a target="_blank" href="http://worswress.org/support/plugin/supsystic-secure"><?php _e('Support', SWR_LANG_CODE)?></a>
	</div>
	<div class="swrAdminFooterCell">|</div>
	<div class="swrAdminFooterCell">
		Add your <a target="_blank" href="http://worswress.org/support/view/plugin-reviews/supsystic-secure?filter=5#postform">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on worswress.org.
	</div>
</div>